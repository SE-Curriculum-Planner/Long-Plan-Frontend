        ...
        {filteredCourses.map((course: any, index: number) => {
          ...
          return (
            <tr
              ...
              } transition duration-300 ease-in-out hover:bg-blue-shadeb1 bg-opacity-70 text-sm`}
            >
              ...
              <td className="px-4 py-2 text-center items-center justify-center">
                ...
                {(groupName === "Core" ||
                  ...
                  <>
                    <div className="inline-block px-2 text-sm w-[50px] font-medium text-white bg-blue-shadeb5 rounded-l-[10px] border border-solid border-blue-shadeb5">
                      Major
                    </div>
                    {groupName === "Core" && (
                      <div
                ...
                {(groupName === "Learner Person" ||
                  ...
                  <>
                    {" "}
                    <div className="inline-block px-2 text-sm w-[20px] font-medium text-collection-1-yellow-shade-y7 bg-collection-1-yellow-shade-y5 rounded-l-[10px] border border-solid border-amber-300">
                      GE
                    </div>
                    {groupName === "Learner Person" && (
                      <div
                ...
                {groupName === "Free Elective" && (
                  <div className="inline-block px-2 text-sm w-[140px] font-medium text-collection-1-black-shade-bl4 bg-collection-1-black-sl rounded-[10px] border border-solid border-collection-1-black-shade-bl4">
                    {groupName}
                  </div>
                )}
              </td>
          ...
          <table className="table-auto border-2 border-solid border-blue-shadeb05 rounded-[20px] w-[1100px] mt-2">
            <thead className="bg-blue-shadeb05 border border-blue-shadeb05 text-blue-shadeb5 text-md">
              <tr>
                ...
                <th className="border-b border-blue-shadeb05 px-4 w-[60px] py-2 text-center">
                  รหัสวิชา
                </th>
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1450px] pl-16 mt-12 justify-center items-center ">
        <div className="flex bg-[#ECEEFA] rounded-t-2xl w-[1450px] shadow-2xl items-center justify-center bg-[url('/imgs/AngkaewBG.svg')] bg-cover ">
          <div className="flex flex-row items-center">
