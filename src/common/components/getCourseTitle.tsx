...
const CourseTitleExtractor: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      ...
      <div className="static top-50 right-5 p-4 bg-white shadow  rounded-[20px]">
        ...
        <div className="mt-10">
          ...
          <p>{`คุณเรียนไปแล้ว ${totalCredits} จาก ${
            curriculumData.requiredCredits || "N/A"
          } หน่วยกิต`}</p>
        </div>
      </div>
    </div>
